...
import { forgotpwdupdatepwd } from '../../actions/adminauth';
const ResetPwd = ({ setAlert, forgotpwdupdatepwd, match, history }) => {
...
export default connect(null, { forgotpwdupdatepwd })(ResetPwd);
